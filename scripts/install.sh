...
#       accessible directory /usr/local/adaq. Note that only
#       Git-tagged production version are available for
#       installation. The tagged version is checked out into its own
