...
AAInterface::AAInterface(int W, int H)
  : TGMainFrame(gClient->GetRoot()),
    ...
    V1718Enable(false), V1720Enable(true), V6534Enable(false),
    ...
    ColorManager(new TColor), RNG(new TRandom)
{
  ...
  // AAInterface can be run without either board by setting the
...
void AAInterface::FillConnectionFrame()
{
  ...
  // ROOT text button that controls connection of AAInterface to the VME boards
